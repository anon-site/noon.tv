...
- **أدوات الوكيل المتقدمة** لحل مشاكل CORS
- **إدارة روابط القنوات** مع فحص ومراجعة شاملة
- **أدوات إدارية شاملة** للمطورين

## 🔧 أدوات الوكيل المتقدمة

### ما هي أدوات الوكيل؟
أدوات الوكيل هي ميزة متقدمة تسمح بحل مشاكل CORS (Cross-Origin Resource Sharing) عند استضافة الموقع على منصات مثل GitHub Pages أو أي خادم ويب لا يدعم CORS بشكل كامل.

### المميزات الرئيسية:

#### 🌐 إعدادات الوكيل
- **تفعيل/إلغاء الوكيل** بسهولة
- **إدخال رابط الوكيل** المخصص (مثل: `https://cors-anywhere.herokuapp.com/`)
- **نطاق التطبيق**: جميع القنوات أو قنوات محددة
- **معاينة فورية** للتغييرات قبل التطبيق

#### 🔗 إدارة الروابط
- **تطبيق الوكيل** على جميع القنوات أو قنوات محددة
- **إزالة الوكيل** من القنوات المحددة
- **اختبار الوكيل** للتأكد من عمله
- **حفظ الإعدادات** تلقائياً في التخزين المحلي

#### 📊 إحصائيات الروابط
- **إجمالي الروابط**: عدد جميع روابط القنوات
- **روابط صحيحة**: الروابط التي تعمل بشكل صحيح
- **روابط معطلة**: الروابط التي تحتاج إصلاح

#### 🛠️ أدوات إضافية
- **فحص جميع الروابط**: التحقق من صحة الروابط
- **تصدير قائمة الروابط**: حفظ جميع الروابط في ملف JSON
- **تحديث جماعي**: تعديل روابط متعددة (قيد التطوير)

### كيفية الاستخدام:

1. **افتح لوحة التحكم** من القائمة الجانبية
2. **انتقل إلى تبويب "الأدوات"**
3. **فعّل الوكيل** وأدخل رابط الخدمة
4. **اختبر الوكيل** للتأكد من عمله
5. **طبّق الوكيل** على القنوات المطلوبة

### أمثلة على خدمات الوكيل:
- `https://cors-anywhere.herokuapp.com/`
- `https://api.allorigins.win/raw?url=`
- `https://thingproxy.freeboard.io/fetch/`

### ملاحظات مهمة:
- ⚠️ تأكد من موثوقية خدمة الوكيل المستخدمة
- 🔒 بعض خدمات الوكيل قد تتطلب تسجيل أو دفع
- 🌐 الوكيل قد يؤثر على سرعة التحميل
- 💾 الإعدادات محفوظة محلياً في المتصفح
